      ...
      <div class="col-md-6">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Add Departemen</h3>
          </div>
          <form action="<?= base_url('departemen/save') ?>" method="post">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" name="nama_dep" id="nama_dep" class="form-control" placeholder="Nama Departemen" value="<?= old('nama_dep') ?>" required>
              </div>
            </div>
